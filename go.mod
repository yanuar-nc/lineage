module github.com/yanuar-nc/lineage
...
require (
	...
	github.com/yanuar-nc/go-boiler-plate v0.0.0-20220602044532-d2e2f2e7e738
...
require (
	...
	github.com/mindstand/gogm/v2 v2.3.4 // indirect
